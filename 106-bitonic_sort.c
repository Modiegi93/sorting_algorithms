 ...
 * @dir: indicate which half to manage
 * @r_size: the size of the whole array
 *
 * Return: Nothing
 */
...
/**
 * _sort - segment the array
 * @array: the array to sort
 * @low: the lowest element in each range
 * @size: size of the range to sort
 * @dir: indicate which half to manage
 * @r_size: the size of all the arrays
 *
 * Return: Nothing
 */
void _sort(int *array, int low, int size, int dir,
	      const int r_size)
{
	int k = size;
